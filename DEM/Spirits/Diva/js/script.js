...
Spirit_Identidy.addEventListener('click', () => {
    ...
    <p>Рост: 165см; замеры тела - B94/W63/H88</p>
...
Spirit_Persona.addEventListener('click', () => {
    ...
    <p>Кокектлива к тем, кто ей понравился. После событий с Да'атом прежнее высокомерие и ненависть к людям ушли. Питает к девушкам слабость. В остальном, <<детская>> личность.</p>`
})
