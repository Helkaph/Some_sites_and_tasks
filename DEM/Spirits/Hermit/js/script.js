...
Spirit_Identidy.addEventListener('click', () => {
    ...
    <p>Рост: 144см; замеры тела - B73/W55/H78</p>
...
Spirit_Persona.addEventListener('click', () => {
    CreateContent();
    Spirit_Text.innerHTML = `<p>Крайне застенчива и пассивна. Поначалу общалась чревовещанием через Йошинон. Субьект <<Да'ат>> даёт ей решимость и уверенность в себе. Иногда может повести грубо.`
})
