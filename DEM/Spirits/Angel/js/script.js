...
Spirit_Identidy.addEventListener('click', () => {
    ...
    <p>Рост: 152см; замеры тела - B75/W55/H79</p>
...
Spirit_Persona.addEventListener('click', () => {
    CreateContent();
    Spirit_Text.innerHTML = `<p>Во время службы в AST проявила себя как умный и талантливый боец. В внеслужебнее время она весёлая и застенчивая девушка.</p>
    <p>Незадолго до ухода из госслужбы проявила признаки раздвоения личности и неконтролируемой ярости. После событий с объектом <<Да'ат>> пришла в норму, за исключением одержимости к объекту и проявления "особых" увлечений рядом с ним.</p>`
})
Spirit_Power.addEventListener('click', () => {
    ...
    <ul>
        ...
        <p>Комплект оружия: пистолет, штурмовая винтовка, пулемёт Гатлинга, Desert Eagle, лазерные мечи <<No Pain>>, тяжёлая снайперская винтовка Cry Cry Cry(CCC)</p></li>
        <li><b><span><<Белая лакрица, DW-029:>></span></b> Модель CR-Unit для тотального разрушения. Рекомендуемое время использования: 30 минут. Оснашена лазерными кластерными орудиями, магическими пушками, ракетницами, лазерными мечами.</li>
        ...
        <li><b><span>CR-Unit "Brynhildr":</span></b> Разработанный Asgard Electronics CR-Unit. Ключевой особенностью является его совместимость с силами Духа.</li>
    </ul>
