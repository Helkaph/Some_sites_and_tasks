...
Spirit_Identidy.addEventListener('click', () => {
    ...
    <p>Рост: 157см; замеры тела - B85/W59/H87</p>
...
Spirit_Power.addEventListener('click', () => {
    ...
    <p><b><span>Дополнительные способности:</span></b> поглощение чужого <<времены>>(жизненных сил) для применения способностей за счёт барьера, управление тенями, создание клонов. 
        `
})
