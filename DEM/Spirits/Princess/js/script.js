...
Spirit_Persona.addEventListener('click', () => {
    CreateContent();
    Spirit_Text.innerHTML = `<p>Поначалу холодная, безэмоциональная и осторожная девушка. После событий с Да'атом начала испытывать и выражать эмоции и чувства. Для неё всё в новинку, она весёлая и наивная девушка с частично детскими манерами
    `
})
