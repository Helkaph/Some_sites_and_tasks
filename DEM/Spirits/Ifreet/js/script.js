...
Spirit_Identidy.addEventListener('click', () => {
    CreateContent();
    Spirit_Text.innerHTML = `<p>Ученице средней школы с двумя хвостиками, заплетённыими ленточками разного цвета. Длинные кораллового цвета волосы и красные глаза. Обладает раздвоением личности, зависящим от цвета надетых ленточек. В форме Духа её волосы распущенны.
    <p>Рост: 152см; замеры тела - B72/W53/H74</p>
